...
class Widget(QWidget): 
    def __init__(self, parent = None):
        ...
        self.social_score_delegate = StarDelegate(self)
        ...
        # Set the delegates: person delegate
        self.ui.tableView.setItemDelegateForColumn(1, self.person_delegate)
        self.ui.treeView.setItemDelegateForColumn(1, self.person_delegate)

        # Set the delegates: start delegate
        self.ui.tableView.setItemDelegateForColumn(3, self.social_score_delegate)
        self.ui.treeView.setItemDelegateForColumn(3, self.social_score_delegate)
